...
La variabilidad relativa (CV) del 1.37\% confirma que el AG es estable y reproducible: ninguna semilla se desvía más del 4\% del óptimo, y dos de las cinco corridas alcanzan brechas inferiores al 2.5\%. La Figura~\ref{fig:robust} ilustra gráficamente la dispersión.
...
\midrule
LP Relajado        & \$27{,}859.93      & ---            & $0.4$              & $-43.20\%$ \\
...
\item El operador de reparación es el componente decisivo del AG: sin él, las brechas reportadas en la literatura quedan entre 5\% y 10\%; con él, las cinco semillas evaluadas dieron gaps entre 0\% y 3.55\%, con un coeficiente de variación del 1.37\%.
